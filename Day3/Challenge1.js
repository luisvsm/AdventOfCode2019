...
function GetCollisions(wire1Array, wire2Array) {
    ...
    var addWireToBoolMap = (wireArray, addToBoolMap) => {
        ...
        var addWire = () => {
            ...
            if (addToBoolMap === false && boolMap[currentPost.x - (minX)][currentPost.y - (minY)] === true) {
                DrawPoint(currentPost, "rgb(0,0,0)");
                if (minDistance > (Math.abs(currentPost.x) + Math.abs(currentPost.y))) {
                    minDistance = (Math.abs(currentPost.x) + Math.abs(currentPost.y));
                ...
                boolMap[currentPost.x - (minX)][currentPost.y - (minY)] = true;
            }
        }
